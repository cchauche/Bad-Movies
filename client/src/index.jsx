...
let dummyMovies = [
  ...
  },
  {
    ...
    overview:
      "In this animated short film featuring Matthew Mcdaid's song, we accompany Joan on a journey through space as he tries to escape from the mossy walls of  the factory he works in.",
    popularity: 2.744,
  ...
  },
  {
    ...
    overview:
      "Within the ecosystem, some strange creatures interact with each other. Organic and mechanical at the same time, some communicate, some reproduce their biological cycles and some others fight for their own survival.",
    popularity: 0.6,
    poster_path: null,
    release_date: "",
  ...
  },
  {
    ...
    overview:
      "María and Amaia win an all-expenses-paid trip with their friends to Benidorm but, when they arrive, they find themselves without resources and decide to sing in the street to earn some money. The success of their street performances will lead them to sign up for a talent show with a € 3,000 prize!",
    popularity: 3.842,
  ...
  },
  {
    ...
    overview:
      "Based on the Wile E. Coyote character and fictitious Acme corporation from the Looney Tunes.",
    popularity: 2.401,
    poster_path: null,
...
let dummyFaves = [
  ...
  },
  {
    ...
    genre_ids: [16, 878, 28, 53],
    id: 780310,
    original_language: "en",
    original_title: "Spinning Primate: Judgement Day",
    overview:
      "Being the sequel to the original Spinning Primate, a robotic chimpanzee from the future to wreak havoc on humanity.",
    popularity: 0,
